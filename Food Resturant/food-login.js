document.addEventListener("DOMContentLoaded", function () {
    ...
    loginForm.addEventListener("submit", function (e) {
        ...
        if (!user) {
            ...
            if (role === 'admin') {
                window.location.href = `admin-home.html?role=${encodeURIComponent(role)}&firstName=${encodeURIComponent(firstName)}&lastName=${encodeURIComponent(lastName)}`;
            } else if (role === 'customer') {
                window.location.href = `customer-home.html?role=${encodeURIComponent(role)}&firstName=${encodeURIComponent(firstName)}&lastName=${encodeURIComponent(lastName)}`;
            }
        }
    });
